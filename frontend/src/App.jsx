      ...
      <div className="hero-container">
        <div className="hero-content">
          <h1 className="hero-headline">
            {hero.headline || 'Crafting secure and scalable digital solutions with code and creativity.'}
          </h1>
          <p className="hero-subheadline">
            {hero.subheadline || 'Hi, I\'m Gaurav Deep. I am a Computer Science Engineering student specializing in IoT, Cybersecurity, and Blockchain Technology.'}
          </p>
        ...
        <div className="hero-visual">
          ...
          <img 
            src={hero.profile_image_url || '/Me.png'} 
...
const Footer = () => {
  ...
  // Fallback URLs if database is not set up
  const defaultLinks = [
    { platform: 'github', url: import.meta.env.VITE_GITHUB_URL || 'https://github.com/GauravDeep25' },
    { platform: 'linkedin', url: import.meta.env.VITE_LINKEDIN_URL || 'https://linkedin.com/in/gauravdeep25' },
    { platform: 'instagram', url: import.meta.env.VITE_INSTAGRAM_URL || 'https://instagram.com/gaurav.d.jpg' }
  ];
